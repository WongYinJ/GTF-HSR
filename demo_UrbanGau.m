...
Ker = fspecial('gaussian',[kernel_length kernel_length],(1/(2*(2.7725887)/ratio^2))^0.5);%% Gaussian kernel
s0=1;kertol=1;
[HSI,Pr,D] = SpatialDegrad(SRI,Ker,ratio,s0,kertol,'center'); % create HSI

H3=reshape(HSI,[Ih*Jh,K]);
%% BGS-GTF-HSR
disp('======================BGS-GTF-HSR applied to Gaussian blurring======================')
P=Pr;P{1,3}=PM;
rho=1e-1;nu=1.1;lambda=1e2;mu=3e0;
